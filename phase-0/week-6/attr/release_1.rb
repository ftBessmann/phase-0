...
class Profile
 ...
 # the change_my_age= syntax might be confusing to see, it just allows us to set the value of the @age variable using = format instead of the standard argument format. 
 # Look at line 71 to see what I mean. The equals sign is just a part of the method name string, nothing special going on here.
...
# I have to use p here because what_is_age only returns the value of @number, it does not print anything to the console.
# The p modifier prints to the console whatever value is returned. Nifty!
puts "--- printing age -----"
