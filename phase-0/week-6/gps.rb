...
# I learnt that variable names should should be descriptive and easy to understand, expessions should be as short as possible though not overly short.
# 2. Did you learn any new methods? What did you learn about them?
# None.
# 3. What did you learn about accessing data in hashes?
# The shortest way to access data in a hash is to to use [] = expression. Though one could use has_key? method to verify if the hash has such a key,
# and values_at to return an array containing the values associated with the given keys.
# 4. What concepts were solidified when working through this challenge?
# Iteration through hashes, accessing values in hashes, raising ArgumentError.
