...
#Initializes instance of class with instance variable @state
# Initialiaze method sets the attributes(properties) of the object shared by all instances of the class
  def initialize(state_of_origin, population_density, population)
    @state = state_of_origin
    @population = population
    @population_density = population_density
  end
# It pull in returned (output) values from private methods predicted_deaths and speed_of_spread methods. Is a public instance method of the class, operates on instance of the class. 
  def virus_effects
    predicted_deaths #(@population_density, @population, @state)
    speed_of_spread #(@population_density, @state)
  end

  # It turns the two methods into private, i.e. accessed only inside the class.
  private
  
  # using control flow and input data counts the number of deaths predicted for a certain state. Numbers are rounded to integers. Prints out string describing predicted deaths of state. 
...
# Based on the population density the speed is calculated. It uses control flow to compare population densities to detemine the speed of the spread  of the virus for a certain state. Outputs a string with speed of spread of the virus. 
